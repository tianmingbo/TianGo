...
class Scraper:
    """这个类其实是处于Engine、Spiders、Pipeline 之间，是连通这三个组件的桥梁。"""
    def __init__(self, crawler: Crawler) -> None:
        self.slot: Optional[Slot] = None
        self.spidermw = SpiderMiddlewareManager.from_crawler(crawler)  # 实例化爬虫中间件
    ...
    def open_spider(self, spider: Spider):
        ...
        yield self.itemproc.open_spider(spider)     # 调用所有pipeline的open_spider
