...
RSA = function () {
        ...
        if (!(n.t <= 0)) {
            ...
            if (0 != g) {
                ...
                for (; --$ >= 0;) {
                    ...
                    if ((i[m] += p.am(0, y, i, $, 0, u)) < y) for (p.dlShiftTo($, v), i.subTo(v, i); i[m] < --y;)
                        i.subTo(v, i)
                }
    ...
    function z(t, e) {
        ...
        for (o.copyTo(i); --p >= 0;)
            if (e.sqrTo(i, n), (t & 1 << p) > 0) e.mulTo(n, o, i); else {
                var a = i;
                i = n, n = a
            }
        return e.revert(i)
    ...
    function h(t, e) {
        ...
        if (e) for (var n = 0; n < t.length; n++)
            i[n] = 255 & t.charCodeAt(n); else for (var o = 0, n = 0; n < t.length; n += 2)
...
}(window), $ = window.$ || {}, $pt = window.$pt || {}, function t(t) {
    return e(t)
}
...
function getpwd(passwd, user, code) {
    user = uin2hex(user);
    return getEncryption(passwd, user, code, undefined)
}