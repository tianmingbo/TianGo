...
function d(t, e, n, o, i, r) {
    return l_((r = l_(l_(e, t), l_(o, r))) << (i = i) | r >>> 32 - i, n)
}
...
function l(t, e) {
    ...
    return 16 == 32 ? Array(o, i) : Array(n, o, i, r)
}
...
var S = {
    "encrypt": function (t, e) {
        return encrypt_(encrypt_y(k(t, e)))
    },
...
RSA = function () {
    ...
    t = "Microsoft Internet Explorer" == navigator.appName ? (_.prototype.am = function (t, e, n, o, i, r) {
        for (var a = 32767 & e, u = e >> 15; 0 <= --r;) {
            var s = 32767 & this[t]
                , c = this[t++] >> 15
                , l = u * s + c * a;
            i = ((s = a * s + ((32767 & l) << 15) + n[o] + (1073741823 & i)) >>> 30) + (l >>> 15) + u * c + (i >>> 30),
                n[o++] = 1073741823 & s
        }
        return i
    }
        ...
        for (var a = 16383 & e, u = e >> 14; 0 <= --r;) {
            var s = 16383 & this[t]
                , c = this[t++] >> 14
                , l = u * s + c * a;
            i = ((s = a * s + ((16383 & l) << 14) + n[o] + i) >> 28) + (l >> 14) + u * c,
                n[o++] = 268435455 & s
        }
        return i
    }
    ...
    if (c.prototype.convert = function (t) {
        ...
        _.prototype.divRemTo = function (t, e, n) {
            ...
            if (!(o.t <= 0)) {
                ...
                var s = r.t
                    , c = r[s - 1];
                if (0 != c) {
                    var i = c * (1 << this.F1) + (1 < s ? r[s - 2] >> this.F2 : 0)
                        , l = this.FV / i
                        , f = (1 << this.F1) / i
                        , d = 1 << this.F2
                        , p = n.t
                    ...
                    for (r.dlShiftTo(h, g),
                        ...
                        r[r.t++] = 0;
                    for (; 0 <= --h;) {
                        var m = n[--p] == c ? this.DM : Math.floor(n[p] * l + (n[p - 1] + d) * f);
        ...
        _.prototype.modPowInt = function (t, e) {
            return e = new (t < 256 || e.isEven() ? c : l)(e),
                this.exp(t, e)
        }
        ,
        _.ZERO = a(0),
...
var sEncode = {
    ...
    "encode": function (t) {
        ...
        var e, n, o = sEncode.PADCHAR, i = sEncode.ALPHA, r = sEncode.getbyte, a = [],
...
function getEncryption(t, e, n, o) {
    n = n || "", t = t || "";
    for (var o = o ? t : c(t), t = c(w(o) + e), n = S.strToBytes(n.toUpperCase(), !0), i = Number(n.length / 2).toString(16); i.length < 4;)
        i = "0" + i;
    S.initkey(t),
        n = S.encrypt(o + S.strToBytes(e) + i + n),
        S.initkey("");
    for (var r = Number(n.length / 2).toString(16); r.length < 4;)
        r = "0" + r;
    return n = RSA.rsa_encrypt(w(r + n)),
        setTimeout(function () {
            !function (t, e) {
                if (!(Math.random() > (e || 1)))
                    try {
                        var n = 'https:' + "//ui.ptlogin2.qq.com/cgi-bin/report?id=" + t;
                    } catch (o) {
                    }
            }(488358, 1)
        }, 0),
        sEncode.encode(w(n)).replace(/[\/\+=]/g, function (t) {
            return {
                "/": "-",
                "+": "*",
                "=": "_"
...
function getPwd(pwd, user, code) {
    // let salt = `\u0000\u0000\u0000\u0000${uin2hex(user)}`;
    let salt = uin2hex(user);
    return getEncryption(pwd, salt, code)
}
