function decode(t) {
  ...
  var l = function (t) {
    throw new u(t)
  }, c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", f = /[\t\n\f\r ]/g
...
function getData(encryptData) {
  return JSON.parse(s("5e5062e82f15fe4ca9d24bc5", decode(encryptData), 0, 0, "012345677890123", 1))
}
