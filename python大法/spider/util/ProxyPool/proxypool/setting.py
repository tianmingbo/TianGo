...
REDIS_HOST = env.str('PROXYPOOL_REDIS_HOST',
                     env.str('REDIS_HOST', '150.158.47.35'))
# redis port
...
PROXY_SCORE_MAX = 100  # 可用代理分数设置为100
PROXY_SCORE_MIN = 0
PROXY_SCORE_INIT = 10  # 新增的代理分数设置为10
...
# })
TEST_VALID_STATUS = env.list('TEST_VALID_STATUS', [200, 206, 302])  # 有效的响应码
