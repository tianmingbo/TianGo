...
Java.perform(function () {
    ...
    AuthorizeHelper.xAuthencode.overload('android.content.Context', 'java.lang.String', 'java.lang.String', 'java.lang.String', 'boolean').implementation = function (a, b, c, d, e) {
        // console.log("xAuthencode:", b, '------', c, '------', d, '------', e);
...
function call_java() {
    Java.perform(function () {
        ...
        var context = current_application.getApplicationContext(); //构建context对象
...
// var base64 = soAddr.add(0x6E3C + 1);
// hook_native_addr(base64, 3);


// var shaFinal = soAddr.add(0x6A80 + 1);
// hook_native_addr(shaFinal, 3);
...
var setKey = soAddr.add(0x6938 + 1);  //get key
