...
//
//	mockgen -source=C:\Users\westwell\Desktop\tmb\TianGo\Language\go\projects\webook\internal\service\types.go -package=svcmocks -destination=C:\Users\westwell\Desktop\tmb\TianGo\Language\go\projects\webook\internal\service\mocks\types.go
//
...
// FindOrCreateByFeiShu mocks base method.
func (m *MockUserService) FindOrCreateByFeiShu(ctx context.Context, feiShuInfo domain.FeiShuInfo) (domain.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOrCreateByFeiShu", ctx, feiShuInfo)
	ret0, _ := ret[0].(domain.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FindOrCreateByFeiShu indicates an expected call of FindOrCreateByFeiShu.
func (mr *MockUserServiceMockRecorder) FindOrCreateByFeiShu(ctx, feiShuInfo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindOrCreateByFeiShu", reflect.TypeOf((*MockUserService)(nil).FindOrCreateByFeiShu), ctx, feiShuInfo)
}
