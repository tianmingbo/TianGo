...
class Flask(object):
    ...
    secret_key = None            # 密钥配置，例如可以对cookie进行加密
    ...
    def __init__(self, package_name):
        ...
        #注册的所有视图函数的字典。键是函数名，也用于生成url，值是函数对象本身。
        ...
        #: decorator.
        '''
        在请求分派开始之前，应该在请求开始时调用的函数的列表。例如，这可以用于打开数据库连接或获取当前登录的用户。
        '''
        self.before_request_funcs = []     # 请求开始正式处理之前,可以验证用户是否已登录,权限等
