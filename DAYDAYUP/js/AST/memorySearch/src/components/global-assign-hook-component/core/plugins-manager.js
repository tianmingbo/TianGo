...
function loadPluginsAsString() {
    ...
    const hookJsCode = fs.readFileSync("src/components/global-assign-hook-component/core/hook.js").toString();

    const pluginsJsContentArray = [];
    const pluginsBaseDirectory = "src/components/global-assign-hook-component/plugins/";
